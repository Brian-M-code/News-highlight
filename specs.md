...
email [here](mutuma.brian@yahoo.com),
or by reporting an issue in the [specification
repo](https://github.com/Brian-M-Code/News-highlight/issues).
  ...
  *  **2.2. Usage**
    ...
    1. Fair/Good internet connection.
      ...
      **You can also choose to use the live link**
      <!-- Steps
    1. With a browser of your choice, Visit **https://brian-newshighlights.herokuapp.com/**
